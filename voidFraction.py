...
def Dffan(Rem, EDIA):
    if Rem < 2000:
        ...
        dfm = 1 / (aux1 * aux2)
        dfm = -(1 / 8) * math.log(10) * math.log(10) * dfm
...
def FracaoVazio_comp(jl, jg, rhog, rhol, BETA, D, AREA, EPS, G, MUL, MUG, w_u, w_rho, tol):
   ...
   BETA: ângulo de inclinação do pipe (positivo para escoamento descendente)
